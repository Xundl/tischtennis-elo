...
flask run
python app.py (sollte es fürs ganze Netzwerk startenw34r)

(falls Handy nd geht: Systemsteuerung\System und Sicherheit\Windows Defender Firewall\Zugelassene Apps)
